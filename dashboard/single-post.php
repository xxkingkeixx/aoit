...
<html lang="en">
    ...
    <body>
        ...
        <section class="wrapper section-very-dark">
            <section class="single-thumbnail body full background-normal" data-background="images/Pictures/single-post-thumbnail.jpg">
                <div class="bg-wrapper"></div>
                <div class="front body around-white">
                    <h1 class='font-soft text-big text-upper'>13 : 24</h1> 
                    <h1 class='font-soft text-medium text-upper specing'><i class="glyphicon glyphicon-share"></i> &nbsp; Article</h1>
                ...
                <div class="specing-single section-dark around-white shadow row">
                    <header class="col-lg-12">
                        <div class="page-header">
                            <h1 class='text-big text-upper'>My Article <small class='text-medium-large text-gray'> Inner My Blog</small></h1>
                        </div>
                    </header>
                    <article class="col-lg-12">
                        ...
                        <div class='text-spacing-small'></div>
                        <blockquote>
